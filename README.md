...
Cenário atual:
  Cleiton é dono de imobiliária e atualmente sua equipe realiza os cadastros de agendamento manualmente no whatsapp o que possibilita erros humanos como, criar reservas no mesmo período de outra reserva e ocorre desorganização pela quantidade de reservas.
Frequentemente João agenda visitas para um funcionário em horários que o carro já está sendo utilizado, o que resulta em faltas na visita aos clientes, o que gera insatisfação.
  

Cenário depois da implantação:
  Joaquim desenvolve um sistema que gerenciará todas as reservas, administrando as regras de negócio, evitando duplicidade de agendamentos, notificação ao funcionário para o mesmo ser avisado ao criar a visita, resultando em dimunuição de faltas a visitas a clientes e melhor satisfação dos clientes da imobiliária.
